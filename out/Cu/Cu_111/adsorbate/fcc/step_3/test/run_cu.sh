...
export ASE_ESPRESSO_COMMAND="srun --exclusive --mem-per-cpu=1840 -n 192 -c 4 -N 6 ${HOME}/QE/src/qe-7.2/bin/pw.x -nk 2 -nb 24 -ntg 4 -nd 1 -in PREFIX.pwi | tee PREFIX.pwo"
