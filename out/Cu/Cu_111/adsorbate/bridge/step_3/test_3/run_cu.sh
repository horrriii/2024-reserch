...
export ASE_ESPRESSO_COMMAND="srun --exclusive --mem-per-cpu=1840 -n 768 -c 1 -N 6 ${HOME}/QE/src/qe-7.2/bin/pw.x -nk 3 -nb 32 -ntg 8 -nd 1 -in PREFIX.pwi | tee PREFIX.pwo"
